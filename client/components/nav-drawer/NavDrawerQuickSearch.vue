	...
	>
		...
		>
			<div class="flex w-full items-center justify-center gap-4">
				<i
					class="fa-light fa-filters text-xl text-[--md-sys-color-on-surface-variant]"
				/>
				<div
					class="bg-transparent pr-24 dark:text-[--md-sys-color-primary-fixed-dim]"
				>
					Ctrl + K
				</div>
			</div>
		...
		<div class="flex size-12 items-center justify-center md:hidden">
			<i
				class="fa-light fa-filters text-[--md-sys-color-on-surface-variant)] text-2xl"
			/>
		</div>
	</NuxtLink>
</template>
