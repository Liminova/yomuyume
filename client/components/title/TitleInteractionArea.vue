...
const [addFavorite, deleteFavorite] = [
	useUserFavorite('PUT'),
	useUserFavorite('DELETE')
]
const [addBookmark, deleteBookmark] = [
	useUserBookmark('PUT'),
	useUserBookmark('DELETE')
]
...
<template>
	<div
		:class="
			cn(
				'my-7 flex w-full flex-row items-center justify-start gap-2',
				props.class
			)
		"
	>
