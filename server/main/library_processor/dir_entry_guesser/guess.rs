...
use crate::{
    library_processor::dir_entry_guesser::{
        ScannedChapterInfo, has_pattern_of_a_series::HasPatternOfSeries,
    },
...
impl DirEntryTypeGuesser for DirEntry {
    ...
    fn guess(
        ...
        let not_force_oneshot = !dir.has_oneshot_flag(komga_oneshot_support);
        let not_force_ignore = !dir.has_recycle_flag(komga_recycle_support);
